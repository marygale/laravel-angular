                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <ul class="list-unstyled">
                                            ...
                                            <li>
                                                <p class="text-muted">
                                                    <i class="fa fa-skype"></i>&nbsp;&nbsp;<span class="txt-color-darken">ladyemjay043</span>
                                                </p>
                                            </li>
                                            <li>
                                                <p class="text-muted">
                                ...
                                <div class="other-profile">
                                    ...
                                    <div class="jarviswidget jarviswidget-color-white" id="wid-id-7" data-widget-editbutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-sortable="false" role="widget"
                                        ...
                                        <header role="heading">
                                            <div class="jarviswidget-ctrls" role="menu"><a href="#" class="button-icon jarviswidget-toggle-btn" rel="tooltip" title="" data-placement="bottom" data-original-title="Collapse"><i class="fa fa-minus"></i></a>
